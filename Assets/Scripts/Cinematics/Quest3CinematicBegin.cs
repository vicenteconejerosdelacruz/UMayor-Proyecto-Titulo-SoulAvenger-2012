...
public class Quest3CinematicBegin : CinematicEvent 
{
	public override void onPlay()
	{
		...
		AnimationClip hero_anim_clip = Resources.Load("Cinematics/Quest3/hero_begin") as AnimationClip;
		hero_anim.AddClip(hero_anim_clip,"cinematic");
		hero_anim.Play("cinematic");
		
		string[] enemiesClips = 
		{
			 "Cinematics/Quest3/bigreaper_begin"
		};
		
		string[] enemiesPrefabs = 
		{
			 "Prefabs/Enemies/BigReaper"
		};
