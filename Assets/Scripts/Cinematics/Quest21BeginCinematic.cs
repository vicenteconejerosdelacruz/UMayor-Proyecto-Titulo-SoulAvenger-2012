...
public class Quest21BeginCinematic : CinematicEvent 
{
	public override void onPlay()
	{
		Game game = Game.game;
			...
			AnimationClip hero_anim_clip = Resources.Load("Cinematics/Quest21/hero_begin") as AnimationClip;
			hero_anim.AddClip(hero_anim_clip,"cinematic");
			hero_anim.Play("cinematic");		
						
		string[] enemiesClips = 
		{
			 "Cinematics/Quest21/lava_golem_begin"
		};
		
		string[] enemiesPrefabs = 
		{
			 "Prefabs/Enemies/Lava_Golem"
		};
