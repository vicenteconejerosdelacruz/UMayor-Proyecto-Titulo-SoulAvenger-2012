...
ScreenOrientation       ConvertToUnityScreenOrientation(int hwOrient, EnabledOrientation* outAutorotOrient)
{
    if(outAutorotOrient)
    {
        *outAutorotOrient = (kAutorotateToLandscapeLeft);
    }
...
bool    UnitySetAllowOrientationDetection(bool value){return false;}
...
static bool inputEnabled = YES;

void SetInputEnabled(bool which)
{
    inputEnabled = which;
}
